      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
              ...
              <li class="active"><a href="<?php echo base_url('user/content/teknologi') ?>">Teknologi<span class="sr-only">(current)</span></a></li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="<?php echo base_url('user/akun/profile') ?>">Profile</a></li>
                  <li><a href="<?php echo base_url('user/akun/addstory') ?>">Buat Story</a></li>
